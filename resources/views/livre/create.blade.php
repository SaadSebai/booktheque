	...
	<div class="row">
		...
		<form action="{{ url('livres') }}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group @if($errors->get('livr_nom')) has-error @endif text-right">
				...
				<input type="texe" class="form-control text-right" name="livr_nom" value="{{ old('livr_nom') }}" placeholder="اسم الكتاب">
			</div>
			...
			<div class="form-group @if($errors->get('livr_nivo')) has-error @endif text-right">
				...
				<input type="texe" class="form-control text-right" name="livr_nivo"  value="{{ old('livr_nivo') }}" placeholder="مستوى الكتاب">
			</div>
			...
			<div class="form-group @if($errors->get('ville_prnd')) has-error @endif text-right">
				...
				<input type="texe" class="form-control text-right" name="ville_prnd" value="{{ old('ville_prnd') }}" placeholder="مدينة التبادل">
			</div>
			...
			<div class="form-group">
				<label for=""></label>
				<input type="submit" class="form-control btn btn-primary" name="Enregistrer" value="تسجيل">
			</div>
