	...
	<div class="row">
		...
		<form action="{{ url('documents') }}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group @if($errors->get('fnom')) has-error @endif">
				...
				<input type="texe" class="form-control text-right" name="fnom" value="{{ old('fnom') }}">
			</div>
			...
			<div class="form-group">
                ...
                <div class="form-group">
                    <select class="form-control" id="nivo" name="nivo" value="{{ old('nivo') }}"  dir="rtl" required>
                        <optgroup>
            ...
            <div class="form-group">
                <label for="matiere" class="pull-right">مالمادة</label>
			...
			<div class="from-group @if($errors->get('description')) has-error @endif ">
				...
				<textarea name="description" class="form-control text-right">{{ old('description') }}</textarea>
			...
			<div class="form-group">
                <input class="form-control inputfile" type="file" name="fileplc" id="file">
				<label class="pull-right" for="file"><i class="fas fa-upload" for="file"></i>   رفع الملف</label>
			</div>
            <br>
            <br>
            <br>

            <p class="text-right">:  المرجو رفع انواع الملفات الاتية فقط</p>
            <p class="text-right">pdf,doc,jpeg,jpg,png</p>
            <p class="text-right">3Mo وان لا يتجاوز حجمه</p>
            <br>
            <div class="g-recaptcha pull-right" data-sitekey="6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI"></div>

			<div class="form-group">
				<input type="submit" class="form-control btn btn-primary" value="ادخال" name="Enregistrer">
			</div>
